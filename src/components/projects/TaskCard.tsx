    ...
    <>
      <EntityHoverCard content={hoverContent} disabled={isDragging}>
        <div
          ...
          className={`group flex flex-col gap-1 rounded-lg border border-border/70 bg-background/70 px-2.5 py-2 shadow-sm transition-[background-color,border-color,box-shadow,transform] duration-300 ease-out hover:border-input hover:bg-background hover:shadow-md motion-reduce:transition-none ${
